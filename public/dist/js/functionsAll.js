...
//--------- validar que solo entren numeros y decimales en los campos  -----------------//
$('.input-decimal').keypress(function (tecla) {

    if ((tecla.charCode < 48 || tecla.charCode > 57) && (tecla.charCode !== 46) && (tecla.charCode !== 8)) {
        return false;
    }else {
        let len   = $('.input-decimal').val().length;
        let index = $('.input-decimal').val().indexOf('.');
