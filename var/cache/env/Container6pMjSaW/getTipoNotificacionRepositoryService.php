 ...
 */
class getTipoNotificacionRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoNotificacionRepository' shared autowired service.
     *
     * @return \App\Repository\TipoNotificacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoNotificacionRepository.php';

        return $container->privates['App\\Repository\\TipoNotificacionRepository'] = new \App\Repository\TipoNotificacionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
