 ...
 */
class getAyudaRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\AyudaRepository' shared autowired service.
     *
     * @return \App\Repository\AyudaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AyudaRepository.php';

        return $container->privates['App\\Repository\\AyudaRepository'] = new \App\Repository\AyudaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
