 ...
 */
class getProductoAmortizacionRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProductoAmortizacionRepository' shared autowired service.
     *
     * @return \App\Repository\ProductoAmortizacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductoAmortizacionRepository.php';

        return $container->privates['App\\Repository\\ProductoAmortizacionRepository'] = new \App\Repository\ProductoAmortizacionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
