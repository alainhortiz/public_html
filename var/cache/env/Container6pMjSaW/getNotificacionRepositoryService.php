 ...
 */
class getNotificacionRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\NotificacionRepository' shared autowired service.
     *
     * @return \App\Repository\NotificacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NotificacionRepository.php';

        return $container->privates['App\\Repository\\NotificacionRepository'] = new \App\Repository\NotificacionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
