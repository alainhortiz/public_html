 ...
 */
class getEstadoFondoRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\EstadoFondoRepository' shared autowired service.
     *
     * @return \App\Repository\EstadoFondoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EstadoFondoRepository.php';

        return $container->privates['App\\Repository\\EstadoFondoRepository'] = new \App\Repository\EstadoFondoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
