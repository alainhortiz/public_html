 ...
 */
class getIngresoSaldoRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\IngresoSaldoRepository' shared autowired service.
     *
     * @return \App\Repository\IngresoSaldoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IngresoSaldoRepository.php';

        return $container->privates['App\\Repository\\IngresoSaldoRepository'] = new \App\Repository\IngresoSaldoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
