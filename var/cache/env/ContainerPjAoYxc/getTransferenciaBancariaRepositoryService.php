 ...
 */
class getTransferenciaBancariaRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransferenciaBancariaRepository' shared autowired service.
     *
     * @return \App\Repository\TransferenciaBancariaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransferenciaBancariaRepository.php';

        return $container->privates['App\\Repository\\TransferenciaBancariaRepository'] = new \App\Repository\TransferenciaBancariaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
