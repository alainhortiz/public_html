 ...
 */
class getWesterunionRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\WesterunionRepository' shared autowired service.
     *
     * @return \App\Repository\WesterunionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WesterunionRepository.php';

        return $container->privates['App\\Repository\\WesterunionRepository'] = new \App\Repository\WesterunionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
