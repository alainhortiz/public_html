 ...
 */
class getPackProductoRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\PackProductoRepository' shared autowired service.
     *
     * @return \App\Repository\PackProductoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PackProductoRepository.php';

        return $container->privates['App\\Repository\\PackProductoRepository'] = new \App\Repository\PackProductoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
