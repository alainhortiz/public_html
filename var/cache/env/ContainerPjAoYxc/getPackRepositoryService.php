 ...
 */
class getPackRepositoryService extends App_KernelEnvDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PackRepository.php';

        return $container->privates['App\\Repository\\PackRepository'] = new \App\Repository\PackRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
