 ...
 */
class getVentaProductoRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\VentaProductoRepository' shared autowired service.
     *
     * @return \App\Repository\VentaProductoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VentaProductoRepository.php';

        return $container->privates['App\\Repository\\VentaProductoRepository'] = new \App\Repository\VentaProductoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
