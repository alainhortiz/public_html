 ...
 */
class getDireccionRecogidaRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\DireccionRecogidaRepository' shared autowired service.
     *
     * @return \App\Repository\DireccionRecogidaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DireccionRecogidaRepository.php';

        return $container->privates['App\\Repository\\DireccionRecogidaRepository'] = new \App\Repository\DireccionRecogidaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
