...
/* bizum/new.html.twig */
class __TwigTemplate_fb9a1892c23a2eab571620da826c153e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "bizum/new.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "bizum/new.html.twig", 1);
        ...
        if ( !(null === (isset($context["msj"]) || array_key_exists("msj", $context) ? $context["msj"] : (function () { throw new RuntimeError('Variable "msj" does not exist.', 6, $this->source); })()))) {
            ...
            if (((isset($context["msj"]) || array_key_exists("msj", $context) ? $context["msj"] : (function () { throw new RuntimeError('Variable "msj" does not exist.', 7, $this->source); })()) == 1)) {
                ...
                jQuery(document).ready(function (\$) {
                    toastr[\"error\"](\"Ya existe una cuenta de Bizum\", \"Notification \")
    ...
    <div class=\"register-box text-center\">
        <div class=\"card\" style=\"width: 435px;\">
            <div class=\"card-body\">
                <h3>Crear Nuevo Bizum</h3>
                <br>
                ";
        // line 42
        yield Twig\Extension\CoreExtension::include($this->env, $context, "bizum/_form.html.twig");
        yield "
            </div>
        </div>
    </div>
...
{% block title %}Nuevo Bizum{% endblock %}
    ...
    <div class=\"register-box text-center\">
        <div class=\"card\" style=\"width: 435px;\">
            <div class=\"card-body\">
                <h3>Crear Nuevo Bizum</h3>
                <br>
                {{ include('bizum/_form.html.twig') }}
            </div>
        </div>
    </div>
    </body>
{% endblock %}
", "bizum/new.html.twig", "D:\\SOAINT\\ESPAÑA\\Symfony\\public_html\\templates\\bizum\\new.html.twig");
    }
}
