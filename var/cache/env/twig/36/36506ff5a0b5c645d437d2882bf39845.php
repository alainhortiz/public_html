...
class __TwigTemplate_0091d415093364e747a900daeaf4d593 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        yield "Correo electrónico de restablecimiento de contraseña enviado";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "        <p>
            Si existe una cuenta que coincide con su correo electrónico, entonces se acaba de enviar un correo electrónico que contiene un enlace que puede usar
            para restablecer su contraseña.
            Este enlace caducará
            en ";
        // line 10
        ...
        <p>Si no recibe un correo electrónico, verifique su carpeta de correo no deseado o <a
                    href=\"";
        // line 13
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        yield "\">intentelo otra vez</a>.</p>
";
    ...
    {
        return array (  87 => 13,  81 => 10,  75 => 6,  68 => 5,  54 => 3,  37 => 1,);
    }
...
{% block title %}Correo electrónico de restablecimiento de contraseña enviado{% endblock %}
...
{% block body %}
        <p>
            ...
            para restablecer su contraseña.
            Este enlace caducará
            en {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.
        </p>
        <p>Si no recibe un correo electrónico, verifique su carpeta de correo no deseado o <a
                    href=\"{{ path('app_forgot_password_request') }}\">intentelo otra vez</a>.</p>
{% endblock %}
", "reset_password/check_email.html.twig", "D:\\SOAINT\\ESPAÑA\\Symfony\\public_html\\templates\\reset_password\\check_email.html.twig");
    }
}
