...
class __TwigTemplate_f03ab1c370703231d61c9ae60556a746 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Está seguro que quieres borrar este usuario?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Está seguro que quieres borrar este usuario?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "user/_delete_form.html.twig", "D:\\SOAINT\\ESPAÑA\\Symfony\\public_html\\templates\\user\\_delete_form.html.twig");
    }
}
