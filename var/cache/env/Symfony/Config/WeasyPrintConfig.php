...
require_once __DIR__.\DIRECTORY_SEPARATOR.'WeasyPrint'.\DIRECTORY_SEPARATOR.'PdfConfig.php';
 ...
 */
class WeasyPrintConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    public function pdf(array $value = []): \Symfony\Config\WeasyPrint\PdfConfig
    {
        if (null === $this->pdf) {
            $this->_usedProperties['pdf'] = true;
            $this->pdf = new \Symfony\Config\WeasyPrint\PdfConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('pdf', $value)) {
            $this->_usedProperties['pdf'] = true;
            $this->pdf = new \Symfony\Config\WeasyPrint\PdfConfig($value['pdf']);
            unset($value['pdf']);
        }
