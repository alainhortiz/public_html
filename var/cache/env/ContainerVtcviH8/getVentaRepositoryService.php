 ...
 */
class getVentaRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\VentaRepository' shared autowired service.
     *
     * @return \App\Repository\VentaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VentaRepository.php';

        return $container->privates['App\\Repository\\VentaRepository'] = new \App\Repository\VentaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
