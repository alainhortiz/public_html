 ...
 */
class getRetiroSaldoRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\RetiroSaldoRepository' shared autowired service.
     *
     * @return \App\Repository\RetiroSaldoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RetiroSaldoRepository.php';

        return $container->privates['App\\Repository\\RetiroSaldoRepository'] = new \App\Repository\RetiroSaldoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
