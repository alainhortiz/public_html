 ...
 */
class getVentaCanceladaRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\VentaCanceladaRepository' shared autowired service.
     *
     * @return \App\Repository\VentaCanceladaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VentaCanceladaRepository.php';

        return $container->privates['App\\Repository\\VentaCanceladaRepository'] = new \App\Repository\VentaCanceladaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
