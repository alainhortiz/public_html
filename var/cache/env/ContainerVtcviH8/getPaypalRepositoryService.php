 ...
 */
class getPaypalRepositoryService extends App_KernelEnvDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaypalRepository' shared autowired service.
     *
     * @return \App\Repository\PaypalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaypalRepository.php';

        return $container->privates['App\\Repository\\PaypalRepository'] = new \App\Repository\PaypalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
