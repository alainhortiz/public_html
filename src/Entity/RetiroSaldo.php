...
/**
 * @ORM\Entity(repositoryClass=RetiroSaldoRepository::class)
 */
class RetiroSaldo
{
    const TIPO_PAGO = [
    ...
    /**
     * @ORM\OneToOne(targetEntity=Notificacion::class, mappedBy="retiroSaldo", cascade={"persist", "remove"})
     */
    private ?Notificacion $notificacion;

    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="retiros")
     */
    private ?User $user;
    ...
    public function setNotificacion(Notificacion $notificacion): self
    {
        ...
        if ($notificacion->getRetiroSaldo() !== $this) {
            $notificacion->setRetiroSaldo($this);
        }
